...
namespace LinePaint
{
    ...
    public class SwipeControl_paint
    {
        private Vector2 startPos;
        private Vector2 endPos;
        private LevelManager_paint _levelManager;

        public void SetLevelManager(LevelManager_paint levelManager)
        {
        ...
        {
            if (GameManager_paint.gameStatus == GameStatus.Playing)
            {
